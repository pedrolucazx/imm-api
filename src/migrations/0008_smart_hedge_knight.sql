...
ALTER TABLE "user_profiles" ALTER COLUMN "last_ai_request" SET DATA TYPE timestamp with time zone;--> statement-breakpoint
...
ALTER TABLE "habits" ALTER COLUMN "updated_at" SET DATA TYPE timestamp with time zone;--> statement-breakpoint
...
ALTER TABLE "habit_logs" ALTER COLUMN "completed_at" SET DATA TYPE timestamp with time zone;--> statement-breakpoint
